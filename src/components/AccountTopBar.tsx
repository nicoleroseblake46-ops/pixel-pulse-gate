  ...
  return (
    <div className="sticky top-0 z-30 hidden bg-gradient-primary px-8 py-3 text-primary-foreground shadow-[var(--shadow-elevated)] md:block">
      <div className="mx-auto flex max-w-7xl items-center justify-end gap-3">
        ...
        <NavLink
          to="/profile"
          className="flex h-11 min-w-40 items-center gap-2 rounded-lg bg-primary-foreground/15 px-3 font-semibold text-primary-foreground transition-smooth hover:bg-primary-foreground/25"
        >
          <span className="flex h-8 w-8 items-center justify-center rounded-md bg-primary-foreground text-primary">
